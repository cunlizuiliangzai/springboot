package com.liujia.springredis.aop;



import com.alibaba.fastjson.JSONObject;
import com.liujia.springredis.redissonutil.RedissonLockUtils;
...
public class RedissonLockAop {
    Logger log =    LoggerFactory.getLogger(RedissonLockAop.class);

    /**
     * 切点，拦截被 @RedissonLockAnnotation 修饰的方法
     */
    @Pointcut("@annotation(com.liujia.springredis.aop.RedissonLockAnnotation)")
